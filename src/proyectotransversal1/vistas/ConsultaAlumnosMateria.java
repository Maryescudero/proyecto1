...
private void cargarAlumnosPorMateria() {
    modelo.setRowCount(0); // Limpiamos la tabla antes de cargar los nuevos datos
    Materia selectedMateria = (Materia) jcbMateria.getSelectedItem();
    if (selectedMateria != null) {
        // Utiliza el método consultarAlumnoporMateria de InscripcionData para obtener los alumnos
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 480, 150, 40));
